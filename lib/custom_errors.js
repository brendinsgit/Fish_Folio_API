// First, I'll create some custom error types by extending `Error.prototype`
// This is simplest with ES6 class syntax. I'll set `name` and `message` in
...
// if the client passes an ID that isn't in the DB, I want to return 404
